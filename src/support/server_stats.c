...
/* dump per nfs op related statistics:
 * total        - total operations
 * errors       - errored operations
 * dups         - duplicated operations
 * latency-avg  - average latency
 * latency-min  - minimum latency
 * latency-max  - maximum latency
 * qwait-avg    - average receive queue wait time
 * qwait-min    - minimum receive queue wait time
 * qwait-max    - maximum receive queue wait time
 */
